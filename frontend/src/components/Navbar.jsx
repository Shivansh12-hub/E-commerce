...
export default function Navbar() {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
      ...
      <Link to='/'><img src={assets.logo} className="w-36 h-15" alt="logo" /></Link>
      ...
      <div className='flex items-center gap-6'>
        ...
        <img onClick={() => setVisible(true)} src={assets.img14} alt="menu" className='w-5 cursor-pointer sm:hidden' />
      </div>
      ...
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : "w-0"}`}>
        ...
        <div className='flex flex-col text-gray-600'>
          ...
          <div className='flex items-center gap-4 p-3 cursor-pointer' onClick={() => setVisible(false)}>
            <img src={assets.img4} className='h-4 rotate-180' alt="back" />
            <p>Back</p>
          </div>
